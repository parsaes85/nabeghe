...
function SeasonRow() {
  return (
    <div>
      ...
      <div className="mt-2 space-y-1 sm:pr-10 sm:pl-16">
        <div className="border rounded-xl flex flex-col sm:flex-row sm:justify-between sm:items-center px-3 py-2 sm:py-1">
